...
main()
{
	...
	int i,n, a=0, b=1, c,d,e,r,o,qot,rem, sum=0, temp, count=0;
	...
	printf("\n 5. Welcome to the Programme to check Even or Odd..\n\n");
	printf("Enter a number : ");
	scanf("%d", &n);
	...
	printf("\n 6. Welcome to the programme of Addition :- \n\n");
	...
	printf("\n 7. Welcome to the programme of Substraction :- \n\n");
	...
	printf("\n\n 8. Welcome to the programme of Multiplication of two or more than two numbers :- \n\n");
	...
	printf("9. Welcome to the programme of division \n\n");
